...
def light_decected(image):
    ...
    cv2.putText(image, f"Light: {light} ", (x-30, y-25), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
    cv2.putText(image, f"Distance: {distance*0.1:.2f} ", (x-30, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
    cv2.imwrite("length.jpg", image)


image = cv2.imread("/Users/jiazimo/PycharmProjects/Pycharm_graduation_design/红绿灯识别与动作/红绿灯识别系统/test.jpg")
